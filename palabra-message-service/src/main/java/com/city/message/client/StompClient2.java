...
public class StompClient2 {
    ...
    public static void main(String[] args) {
        ...
        MyStompSessionHandler sessionHandler = Util.connect("6c4ce2cb-fd02-4eba-a189-a3611d989f82",token);
        while (true) {
            String n = new Scanner(System.in).nextLine();
            if (n != null) {
                sessionHandler.sendMessage(n,"44b5fc4b-cb01-49b6-882a-55880c1e82a8");
            }
        }
