...
public class MessageMapper {
    ...
    public static ConversationMessageEntity toEntity(ReplyMessage newTextMessage){
        ConversationMessageEntity entity = new ConversationMessageEntity();
        entity.setText(newTextMessage.getText());
        entity.setDeliveredTime(LocalDateTime.now());
        entity.setConversationId(newTextMessage.getConversationId());
    ...
    public static ConversationMessageEntity toEntity(ForwardMessage newTextMessage){
        ConversationMessageEntity entity = new ConversationMessageEntity();
        entity.setText(newTextMessage.getText());
        entity.setDeliveredTime(LocalDateTime.now());
        return entity;
